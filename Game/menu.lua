...
local mouseLockLookScreenUrl = "http://rhodum.xyz/asset?id=54071825"
local classicLookScreenUrl = "http://rhodum.xyz/Asset?id=45915798"
...
local function createHelpDialog(baseZIndex)
	...
	buttons[2].Function = function() 
		image.Image = "http://rhodum.xyz/Asset?id=45915811"
	end 
	buttons[3] = {}
	buttons[3].Text = "Gear"
	buttons[3].Function = function() 
		image.Image = "http://rhodum.xyz/Asset?id=45917596"
	end
	buttons[4] = {}
	buttons[4].Text = "Zoom"
	buttons[4].Function = function() 	
		image.Image = "http://rhodum.xyz/Asset?id=45915825"
	end 
...
local createSaveDialogs = function()
	...
	while spinnerNum <= 8 do
	   ...
	   spinnerImage.Image = "http://rhodum.xyz/Asset?id=45880710"
			...
			while spin do
				...
				while pos < 8 do
					if pos == spinPos or pos == ((spinPos+1)%8) then
						spinnerIcons[pos+1].Image = "http://rhodum.xyz/Asset?id=45880668"
					else
						spinnerIcons[pos+1].Image = "http://rhodum.xyz/Asset?id=45880710"
					end
