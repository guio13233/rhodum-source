<?php
	class security {
		...
		public static function sendEmailVerificationMessage() {
			...
			mailHandler::sendMail('Your Rhodum verification code is: '.security::getEmailCode().'<br><br>If you did not request this, you can ignore this message<br><br><a href="https://rhodum.xyz">Rhodum</a><br>Please know that this message was generated automatically, do not reply to this. If you need help, send a message to <a href="mailto:info@rhodum.xyz">info@rhodum.xyz</a>.', "Your Rhodum verification code is: ".security::getEmailCode(), $GLOBALS['userTable']['email'], $GLOBALS['userTable']['username']);
		}
	}
?>