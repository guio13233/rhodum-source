$(document).ready(function() {
	$("#rSubmit").click(function() {
		if ($("#rSubmit").is(":disabled") == false) {
            ...
            //invite key
            //formData.append('invkey', $("#InviteKey").val());
			...
			$.ajax({
				...
				success: function(data) {
					...
					}else if (data == "bad-invite") {
						$("#rStatus").html("<div class=\"alert alert-danger\">Invalid invite key.</div>");
					}
				},
				error: function() {
					$("#rStatus").html("<div class=\"alert alert-danger\">Unexpected network error. Try again later.</div>");
