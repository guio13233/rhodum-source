...
$(document).ready(function() {
	...
	$("#regen").click(function() {
		if ($("#regen").is(":disabled") == false) {
			...
			$("#poseStatus").html("<div class=\"alert alert-success\"><i class=\"fas fa-sync fa-spin\"></i> Regenerating character...</div>");
		}
	})
...
function startGeneration(userID) {
	...
	var characterElement = document.getElementById('character');
		characterElement.src = 'http://labs.rhodum.xyz/imageServer/user/'+userID+'.png?tick=' + Math.random();
	}, 5000);
}
