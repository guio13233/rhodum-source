<?php
	if (isset($_POST['username']) && isset($_POST['csrf'])) {
		...
		mailHandler::sendMail('Hello '.$username.'! You can reset your password at http://rhodum.xyz/account/resetpassword/'.$userID.'/'.$key.' if you did not request this, you can ignore this. <br><br><a href="http://rhodum.xyz">Rhodum</a><br>Please know that this message was generated automatically, do not reply to this. If you need help, send a message to <a href="mailto:support@rhodum.xyz">support@rhodum.xyz</a>.', "Hello ".$username."! You can reset your password at http://rhodum.xyz/account/resetpassword/".$userID."/".$key." if you did not request this, you can ignore this.", $email, "Rhodum Password Reset", $username);
