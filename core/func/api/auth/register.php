<?php
	if (isset($_POST['username']) && isset($_POST['email']) && isset($_POST['passwd1']) && isset($_POST['passwd2']) && isset($_POST['csrf']) && isset($_POST['captcha'])) {
        ...
        // invite key
		//if ($invitekey != "4I15a3Pc1fYbFnKw") {
        //    if ($invitekey != "frostss2021") {
        //        if ($invitekey != "falconss2021") {
        //            if ($invitekey != "dominatorss2021") {
        //                if ($invitekey != "teslaSS2021") {
        //                    if ($invitekey != "astriaSS2021") {
        //                        echo 'bad-invite';
        //                        exit;    
        //                    } 
        //                }               
		...
		$response = json_decode(file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=6Lclnf8ZAAAAABunG1euKzZO_nOvU5ln0UaAT1VM&response=".$_POST['captcha']."&remoteip=".auth::getIP()), true);
		...
		$good_emails = array('@outlook', '@protonmail.com', '@rhodum.xyz', '@roblox.com', '@icloud.com', '@protonmail.ch', '@google.com',
