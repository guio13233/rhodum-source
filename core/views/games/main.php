		...
		<div class="container">
			...
			<div class="col-xs-12 col-sm-12 col-md-8">
				...
				<div class="btn-group btn-group-justified" style="margin-bottom:0px;">
					...
					<a class="btn btn-default" id="v0">2010</a>
                    <a class="btn btn-default" id="v2">2016</a>
				</div>
				<div class="btn-group btn-group-justified" style="margin-bottom:23px;">
					...
					<?php
						if ($GLOBALS['loggedIn']) {
							echo '<a href="/core/views/games/download2010.php" class="btn btn-default d08" style="-webkit-box-shadow:none;box-shadow:none;display:none">Download 2010</a>';
						}
					?>
					<?php
						if ($GLOBALS['loggedIn']) {
							echo '<a disabled class="btn btn-default d08" style="-webkit-box-shadow:none;box-shadow:none;display:none">Download 2016</a>';
						}
					?>
				</div>
				<div id="result">
