			...
			<div id="settingsContent" class="tab-content">
				<div class="tab-pane active fade in" id="account">
					<div class="well profileCard">
						<h4 style="display:inline">About Me</h4> <p style="display:inline;color:grey">You can set your text here which will appear on your profile. <b>If you include (mycoins) , it will be replaced with your coins.</b></p>
