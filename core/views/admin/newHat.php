		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-8">
                    ...
                    <input type="checkbox" id="face"> Face
					<input type="checkbox" id="isBuyable"> Buyable
					<input type="checkbox" id="isRBX"> Roblox Asset (ALWAYS CHECK IF NOT CUSTOM MADE!!!)
                    <input type="checkbox" id="isLimited"> Limited
                    <input class="form-control" id="stock" type="number" placeholder="Hat Stock (if limited)"></input>
					<br>
					<div class="row">
						<div class="col-xs-6">
							<h4>Mesh File</h4>
