<?php
	...
	if (isset($_GET['mode'])) {
		...
		if ($mode == "shirts") {
			echo 'http://rhodum.xyz/data/assets/hats/models/invisible;http://rhodum.xyz/data/assets/shirts/models/get.php?id='.$assetId;
			$dbcon = null;
			exit;
		}
		if ($mode == "pants") {
			echo 'http://rhodum.xyz/data/assets/hats/models/invisible;http://rhodum.xyz/data/assets/pants/models/get.php?id='.$assetId;
			$dbcon = null;
			exit;
		}
		if ($mode == "ts") {
			echo 'http://rhodum.xyz/data/assets/hats/models/invisible;http://rhodum.xyz/data/assets/tshirts/models/get.php?id='.$assetId;
			$dbcon = null;
			exit;
		}
		if ($mode == "ch") {
